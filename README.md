...
I don’t just deploy infrastructure — **I engineer platforms**.
...
- **Docker** – Intermediate
- **Kubernetes**
  - Deployed **3-tier web applications**
  - Managed & deployed **microservices architectures**
...
- Secrets management
- Policy enforcement
- Security scanning & compliance awareness
...
**Solution:**  
- Designed cloud infrastructure using **Terraform**
...
- Applied security best practices (IAM, secrets, policies)
...
- I love turning chaos into clean automation
- I build with **future growth** in mind
